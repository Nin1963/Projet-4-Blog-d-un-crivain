				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="index.php?action=chapter&amp;id=1">Chapitre 1 - New York</a>
							<a class="dropdown-item" href="index.php?action=chapter&amp;id=2">Chapitre 2 - La Panne</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="index.php?action=chapter&amp;id=3">Chapitre 3 - Le départ</a>
						</div>
					</li>
					<li class="nav-item">
