...
<div class="container">
    ...
    <?php while ($data = $chapters->fetch()): ?>
        ...
        <h2><strong><?= htmlspecialchars($data['title']) ?></strong></h2><em>le <?= $data['creation_date_fr'] ?></em>
        <p><?= substr($data['content'], 0, 200) ?>....... <a href="index.php?action=chapter&amp;id=<?= $data['id'] ?>">Lire la suite</a></p>
